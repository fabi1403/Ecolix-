...
function ShopPage() {
  ...
  const handlePaymentMethodSelect = (methodName) => {
    console.log('handlePaymentMethodSelect called with:', methodName);
  ...
  const handleSubmit = (e) => {
    ...
    setSelectedProductsList([]); // Clear the selected products list
  ...
  const renderPaymentFields = () => {
    console.log('renderPaymentFields called, selectedPaymentMethod:', selectedPaymentMethod);
      ...
      <div className="payment-methods-container">
        ...
        <div className="payment-logos-grid">
          {paymentMethods.map((method, index) => (
            <div key={method.name} className="payment-logo-card" style={getPaymentLogoCardStyle(method.name)} onClick={() => {
